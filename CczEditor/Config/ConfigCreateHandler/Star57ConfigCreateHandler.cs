...
namespace CczEditor
{
    public class Star57ConfigCreateHandler : ConfigCreateHandler
    {
        protected override void CreateBaseInfo()
        {
            result.VersionName = "Star 5.7";
            if (result.DisplayName == null) result.DisplayName = "신조조전 5.7";
        ...
        protected override void CreateCodeOptionSettings()
        {
            ...
            result.CodeOptionContainer.MagicLearnExtension = false;
        ...
        protected override void CreateDataSettings()
        {
            ...
            result.Data.ForceLength = 0x1B;

            result.Data.MagicCount = 0x4A;
            result.Data.MagicOffset = 0xAF84;
            result.Data.MagicLength = 0x61;

            result.Data.TerrainOffset = 0xA624;

            result.Data.StarItemCount = 0x8C;
        ...
        protected override void CreateImsgSettings()
        {
            ...
            result.Imsg.MagicOffset = 0x7F30;
        ...
        protected override void CreateItemSettings()
        {
            ...
            result.Items.WeaponIndexMax = 13;
            result.Items.ArmorIndexMin = 14;
            result.Items.ArmorIndexMax = 17;
            result.Items.AuxiliaryIndexMin = 18;
            result.Items.AuxiliaryIndexMax = 107;
            result.Items.ConsumablesMin = 63;
            result.Items.ConsumablesMax = 76;
            result.Items.MineInstall = 77;
            result.Items.MineControl = 78;
            result.Items.Mine = 79;
            result.Items.Bomb = 80;
        }
